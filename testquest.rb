...
#*********************************************************
    ...
    def location_0_1_0
        ...
        @game.screen "You are outside on a bright sunny day. There is a path going south and a tiny house to your north. There also is a tree filled with tasty berries."
        while true
            ...
            when "2"
                ...
                while true
                    ...
                    when "2"
                        ...
                        @game.screen "The troll still has #{@game.get_npc_attribute(0,"Health")}% health left."
                        @game.screen "You still have #{@game.get_player_attribute("Health")}% health left."
